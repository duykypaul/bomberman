...
public class Bomber extends Character {
    ...
    private final int _timeItem = 1000;
...
//                    Game.addBombRate(2 - Game.getBombRate());
//                } else {
//                    System.out.println(Game.getBombRate());
//                    Game.addBombRate(1 - Game.getBombRate());
//                }
                Game.addBombRate(1);
...
//        System.out.println(tileX + " " + tileY);
    ...
    public void addItem(Item aThis) {
        ...
        if (aThis instanceof BombItem) {
            _timeUsedBombItem = _timeItem; // ~ 120 seconds
            _UsedBombItem = true;
        } else if (aThis instanceof SpeedItem) {
            _timeUsedSpeedItem = _timeItem;
            _UsedSpeedItem = true;
        } else if (aThis instanceof FlameItem) {
            _timeUsedFlameItem = _timeItem;
            _UsedFlameItem = true;
        }
        aThis.setValues();
    }
